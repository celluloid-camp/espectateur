export default {
  ...
  home: {
    ...
    invalidVideoFile: 'Invalid file format',
    invalidPlayer: 'Invalid video player',
    invalidLink: 'Invalid link',
    acceptedFormats: 'Accepted formats : webm, mp4, avi, m4a, m4v, mkv, mov, flv, ogv, wmv, mts',
    waitForUpload: 'Upload started : it can be long',
    invalidShareCode: 'Invalid share code',
    invalidUserShared: 'You already are member of this project'
  },
  ...
  project: {
    ...
    annotationsVisibilityAnalyze: 'Analyze',
    ...
    dublintitle: 'Title',
    dublincreator:  'Creator',
    dublinsubject:  'Subject',
    dublindescription:  'Description',
    dublinpublisher:  'Publisher',
    dublincontributor:  'Contributor',
    dublindate:  'Date',
    dublintype:  'Type',
    dublinformat:  'Format',
    dublinidentifier:  'Identifier',
    dublinsource:  'Source',
    dublinlanguage:  'Language',
    dublinrelation:  'Relation',
    dublincoverage:  'Coverage',
    dublinrights:  'Rights',
    ...
    joinProjectDescription: 'Enter project share code to join it',

    assignmentPlaceholder: 'Add an assignment',
    tagsPlaceholder: 'Search or create tag…',

    loadingFailed: 'Loading failed, if it\'s a young project : the video should be processed very soon, '
      + ' else : it maybe was deleted',
