                ...
                >
                  {annotation.performance_mode
                    ? ( annotation.sequencing ?
                      ...
                      : 
                      <span
                        dangerouslySetInnerHTML={{ __html: '[' + t('project.performance_mode_tag') + '] ' + richText }}
                      />
                    ) : (
                      annotation.sequencing ?
                      <span
                    ...
                    <>
                      ...
                      />
                      <span
                        dangerouslySetInnerHTML={{ __html: ' [' + t('project.analyze_mode_tag') +
                         '] ' + richText }}
                      />
                    </>
                    )
